...
def create_params(encoder_lrs,
                  ...
                  load_gcs_bucket='neuralblast_public',
                  data_partitions_dirpath='random_split/',
                  save_gcs_bucket='sequin-public',
    ...
    for encoder_lr, lens_lr, predictor_lr, encoder_wd, lens_wd, predictor_wd, reduce_fn_kwargs_path, lens_train_samples, model_random_key in \
     itertools.product(encoder_lrs, lens_lrs, predictor_lrs, encoder_wds, lens_wds, predictor_wds, reduce_fn_kwargs_paths, lens_train_samples, model_random_keys):
        ...
        param_dict = {
            ...
            'model_random_key': model_random_key,
            'use_transformer': use_transformer,
            'use_bert': use_bert,
            'load_gcs_bucket': load_gcs_bucket,
            'data_partitions_dirpath': data_partitions_dirpath,
            'save_gcs_bucket': save_gcs_bucket,
...
def main(load_gcs_bucket, save_gcs_bucket):
...
if __name__ == '__main__':
    main(load_gcs_bucket='neuralblast_public',
         save_gcs_bucket='sequin-public')
